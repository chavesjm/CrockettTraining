...
//		psi = psi * 180./ PI;
		...
		if(SerialDebug)
		{
			...
			BluethootSerial.print(",");
			BluethootSerial.print(value,2);
			BluethootSerial.print(",");
			BluethootSerial.print(yaw, 2);
			BluethootSerial.print(",");
			BluethootSerial.print(pitch, 2);
			BluethootSerial.print(",");
			BluethootSerial.print(roll, 2);
			BluethootSerial.print(",");
			BluethootSerial.print(yaw_initial, 2);
			BluethootSerial.print(",");
			BluethootSerial.print(pitch_initial, 2);
			BluethootSerial.print(",");
			BluethootSerial.print(roll_initial, 2);
			BluethootSerial.print(",");
			BluethootSerial.print(yaw-yaw_initial, 2);
			BluethootSerial.print(",");
			BluethootSerial.print(pitch-pitch_initial, 2);
			BluethootSerial.print(",");
			...
			Serial.print(",");
			Serial.print(yaw-yaw_initial, 2);
			Serial.print(",");
			Serial.print(pitch-pitch_initial, 2);
			Serial.print(",");
...
>>>>>>> 6bb0efb4252195e8b569dacbdaffab7abf1308f1
